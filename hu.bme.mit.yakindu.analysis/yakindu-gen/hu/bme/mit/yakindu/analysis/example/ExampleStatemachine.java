...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_Nyelo:
				main_region_Nyelo_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_Nyelo:
			return stateVector[0] == State.main_region_Nyelo;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state Nyelo */
	private void enterSequence_main_region_Nyelo_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Nyelo;
	}
	...
	/* Default exit sequence for state Nyelo */
	private void exitSequence_main_region_Nyelo() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_Nyelo:
			exitSequence_main_region_Nyelo();
			break;
		default:
			break;
		}
			...
			if (react()==false) {
				if (sCInterface.start) {
					...
					if (sCInterface.white) {
						exitSequence_main_region_Init();
						enterSequence_main_region_Nyelo_default();
					} else {
	...
	private boolean main_region_Nyelo_react(boolean try_transition) {
		boolean did_transition = try_transition;
